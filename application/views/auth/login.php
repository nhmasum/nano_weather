                    ...
                    <form class="form-horizontal" action="<?php echo base_url('auth/login');?>" method="post">
                        <div class="panel-body">
                            ...
                            if($this->session->flashdata('error')){
                                ...
                                echo '<div class="form-group text-center"><div class="col-sm-9"><div class="text-normal">If you are not a registered user, <a href="'.base_url("auth/registration").'">Click here</a></div></div></div>';
                            }
                            ?>
